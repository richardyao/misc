...
set object 1 rectangle from graph 0.998,graph 0 to graph 1,graph 1 lw 2 fs empty border lc lt 2
set object 2 rectangle from graph 0,graph 0 to graph 0.002,graph 1 lw 2 fs empty border lc lt 1
